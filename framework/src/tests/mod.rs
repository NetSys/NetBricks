...
#[rustfmt::skip]
pub const ICMP_ROUTER_ADVERTISEMENT_BYTES: [u8;118] = [
    // --- Ethernet Header ---
    // Destination MAC
    0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
    // Source MAC
...
#[rustfmt::skip]
pub const ICMP_ROUTER_ADVERTISEMENT_BYTES_NO_LINK_LAYER_ADDRESS: [u8;110] = [
    // --- Ethernet Header ---
    // Destination MAC
    0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
    // Source MAC
...
#[rustfmt::skip]
pub const ICMP_ROUTER_ADVERTISEMENT_BYTES_INVALID_OPTION_LENGTH: [u8;78] = [
    // --- Ethernet Header ---
    // Destination MAC
    0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
    // Source MAC
    ...
    // Retrans timer
    0x00,0x00, 0x05, 0xdc,
    // ICMPv6 Option(MTU) with Invalid Option Length
    0x05, 0x08, 0x00, 0x00, 0x00, 0x00, 0x05, 0xdc,
];

#[rustfmt::skip]
pub const ICMP_ROUTER_ADVERTISEMENT_BYTES_INVALID_OPTION_TYPE: [u8;78] = [
    // --- Ethernet Header ---
    // Destination MAC
    0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
    // Source MAC
